...
readonly LDAP_DOMAIN=gameofthrones.com
readonly LDAP_ORGANISATION="Game of Thrones"
readonly LDAP_BINDDN="cn=admin,dc=gameofthrones,dc=com"
readonly LDAP_SECRET=winteriscoming
